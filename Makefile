...
tokens.c utils.c ft_char_print_utils.c ft_number_print_utils.c ft_printf.c parser.c lexer1.c \
lexer2.c lexer_cases1.c lexer_cases2.c lexer_cases3.c lexer_cases4.c string_utils.c nodes.c

HEADERS=lexer.h lexer_cases.h lexer_utils.h string_builder.h string_utils.h tokens.h utils.h \
ft_printf.h parser.h nodes.h
